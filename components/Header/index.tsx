...
/* Cast the imported menuData to our typed shape.
   If your menuData is already typed / exported as MenuItem[] you can remove the cast. */
                    ...
                    <li key={index} className="group relative">
                      {menuItem.path ? (
                        ...
                        <>
                          ...
                          >
                            {menuItem.submenu?.map((submenuItem: SubmenuItem, subIndex: number) => (
                              <Link
